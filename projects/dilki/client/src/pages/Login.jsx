...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <p className='text-center text-sm mb-6'>{state === 'Sign Up' ? 'Create a new account' : 'Login to your account'}</p>
      ...
      <form onSubmit={onSubmitHandler} >
        ...
        <h3 onClick={()=>navigate('/reset-password')} className='mb-4 text-indigo-500 cursor-pointer'>Forgot password?</h3>
